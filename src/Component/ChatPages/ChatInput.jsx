...
const ChatInput = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className={`absolute -inset-1 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-600 rounded-2xl blur-lg opacity-0 transition-opacity duration-300 ${
